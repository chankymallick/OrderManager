...
IF NOT EXISTS (SELECT *FROM USERS  WHERE USER_ID = 'Administrator')
  BEGIN
    EXECUTE('INSERT INTO USERS (USER_ID,USER_FIRST_NAME,USER_LAST_NAME,LANGUAGE_PREFERENCE,USER_TYPE,ENABLED,PASSWORD) VALUES(''chanky'',''Chanky'',''Mallick'',''English'',''ADMIN'',1,''CSvrS5dgnrk='')')
END
...
EXECUTE ('CREATE TABLE ACCOUNTS_BOOK (
	...
	NOTE  VARCHAR(50) NOT NULL,
                  CONSTRAINT PK_ACCOUNTS PRIMARY KEY NONCLUSTERED (TRANSACTION_UID)
)')
END
IF NOT EXISTS (SELECT *FROM OBJECT_METADATA  WHERE OBJECT_NAME = 'ACCOUNTS_BOOK' AND OBJECT_TYPE='TABLE')
  BEGIN
...
IF NOT EXISTS (SELECT *FROM OBJECT_METADATA  WHERE OBJECT_NAME = 'ACCOUNT_BOOK_SUBTYPES' AND OBJECT_TYPE='TABLE')  
BEGIN
EXECUTE ('CREATE TABLE ACCOUNT_BOOK_SUBTYPES (
	TRANSACTION_UID INT NOT NULL,
                  ACCOUNT_MODULE VARCHAR(50) NOT NULL,
                  ACCOUNT_SUBTYPE VARCHAR(50) NOT NULL,                 
                  ACTIVE BIT DEFAULT 1,
	NOTE  VARCHAR(50) NOT NULL,
                  CONSTRAINT PK_ACCOUNT_BOOK_SUBTYPES PRIMARY KEY NONCLUSTERED (TRANSACTION_UID)
)')
END
IF NOT EXISTS (SELECT *FROM OBJECT_METADATA  WHERE OBJECT_NAME = 'ACCOUNT_BOOK_SUBTYPES' AND OBJECT_TYPE='TABLE')
  BEGIN
  EXECUTE('INSERT INTO OBJECT_METADATA (OBJECT_UID,OBJECT_TYPE,OBJECT_NAME) VALUES(17,''TABLE'',''ACCOUNT_BOOK_SUBTYPES'')')
END


IF NOT EXISTS (SELECT *FROM OBJECT_METADATA  WHERE OBJECT_NAME = 'USER_ROLES' AND OBJECT_TYPE='TABLE')  
BEGIN
EXECUTE ('CREATE TABLE USER_ROLES (
	USER_ROLE_ID INT NOT NULL,
                  USERNAME VARCHAR(30) NOT NULL,
                  ROLE_NAME VARCHAR(50) NOT NULL,
                  CONSTRAINT PK_USER_ROLES PRIMARY KEY NONCLUSTERED (USER_ROLE_ID),
                  CONSTRAINT FK_USER_ROLES FOREIGN KEY (USERNAME) REFERENCES USERS(USER_ID))')
END
IF NOT EXISTS (SELECT *FROM OBJECT_METADATA  WHERE OBJECT_NAME = 'USER_ROLES' AND OBJECT_TYPE='TABLE')
  BEGIN
  EXECUTE('INSERT INTO OBJECT_METADATA (OBJECT_UID,OBJECT_TYPE,OBJECT_NAME) VALUES(18,''TABLE'',''USER_ROLES'')')
END


IF NOT EXISTS (SELECT *FROM OBJECT_METADATA  WHERE OBJECT_NAME = 'IMAGE_STORE' AND OBJECT_TYPE='TABLE')  
BEGIN
EXECUTE ('CREATE TABLE IMAGE_STORE (
                  IMAGE_ID INT NOT NULL,
                  MODULE_NAME VARCHAR(30) NOT NULL,
                  IMAGE_KEY VARCHAR(50) NOT NULL,
                  IMAGE VARCHAR(MAX) NOT NULL,
                  IMAGE_DATE DATETIME DEFAULT GETDATE(),
                  NOTE VARCHAR(200)
                  CONSTRAINT PK_IMAGE_STORE PRIMARY KEY NONCLUSTERED (IMAGE_ID),
                  )')
END
IF NOT EXISTS (SELECT *FROM OBJECT_METADATA  WHERE OBJECT_NAME = 'IMAGE_STORE' AND OBJECT_TYPE='TABLE')
  BEGIN
  EXECUTE('INSERT INTO OBJECT_METADATA (OBJECT_UID,OBJECT_TYPE,OBJECT_NAME) VALUES(19,''TABLE'',''IMAGE_STORE'')')
END


IF NOT EXISTS (SELECT *FROM OBJECT_METADATA  WHERE OBJECT_NAME = 'TASK_LIST' AND OBJECT_TYPE='TABLE')  
BEGIN
EXECUTE ('CREATE TABLE TASK_LIST (
                  ...
                  NOTE VARCHAR(200)
                  CONSTRAINT PK_TASK_LIST PRIMARY KEY NONCLUSTERED (TASK_ID),
                  )')
END
IF NOT EXISTS (SELECT *FROM OBJECT_METADATA  WHERE OBJECT_NAME = 'TASK_LIST' AND OBJECT_TYPE='TABLE')
  BEGIN
  EXECUTE('INSERT INTO OBJECT_METADATA (OBJECT_UID,OBJECT_TYPE,OBJECT_NAME) VALUES(20,''TABLE'',''TASK_LIST'')')
END
