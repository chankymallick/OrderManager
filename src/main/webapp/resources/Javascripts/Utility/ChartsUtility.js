...
(function (com) {
    ...
    (function (ordermanager) {
        var utility;
        (function (utility) {
            var ChartsUtility = /** @class */ (function () {
                function ChartsUtility(objectToAttach, chartName) {
                ...
                ChartsUtility.prototype.taskList = function () {
                    ...
                    this.TaskListGrid.attachEvent("onXLE", function () {
                        _this.TaskListGrid.detachHeader(0);
                    });
                    this.TaskListGrid.attachEvent("onRowSelect", function (id, ind) {
                    });
                };
                ChartsUtility.prototype.updateTask = function (TaskId) {
                    var _this = this;
                    ...
                    formObj.attachEvent("onButtonClick", function (id) {
                        ...
                        if (Response.RESPONSE_STATUS === "SUCCESS") {
                            ...
                            _this.TaskListGrid.load("LoadDataViewGrid?gridname=taskList");
                            winObj.close();
                        }
                ...
                ChartsUtility.orderEnquiry = function (BillNo) {
                    ...
                    PaymentDataGrid.attachEvent("onXLE", function () {
                    ...
                    orderAssignmentGrid.attachEvent("onXLE", function () {
                    ...
                    orderItemsGrid.attachEvent("onXLE", function () {
                    ...
                    if (Response.RESPONSE_STATUS === "SUCCESS") {
                        ...
                        orderDetailGrid.attachEvent("onXLE", function () {
                        });
            ...
            utility.ChartsUtility = ChartsUtility;
